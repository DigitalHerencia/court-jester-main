    ...
    return (
      <div className="flex h-[calc(100vh-120px)] items-center justify-center">
        <div className="text-center">
          <div className="mb-4 text-2xl font-bold">Loading motion details...</div>
    ...
    return (
      <div className="flex h-[calc(100vh-120px)] items-center justify-center">
        <div className="text-center">
          ...
          <div className="mb-4 text-foreground/60">{error || "Failed to load motion details."}</div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Motion Details</h1>
        {motion.pdf_url && (
          <Button className="bg-foreground text-background" disabled={isDownloading} onClick={handleDownloadPdf}>
            {isDownloading ? (
              <>
      ...
      <Card>
        ...
        <CardContent>
          <div className="mb-4 grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="font-medium">Court:</span> {motion.case.court}
            </div>
          </div>
          <p>{motion.content}</p>
        </CardContent>
